# Smart-Lock-System-STM32-AI-Gesture-Recognitio
...
cd Smart-Lock-System-STM32-AI-Gesture-Recognitio
```
```
...
2. **Python Setup:** Install dependencies:
   ...
   ```
3. **Run AI Script:** Navigate to the `Python_AI` folder, update the `PORT_COM` variable in `main_vision.py`, and run:
   ```bash
